...
export default function InputComponent(props) {
  ...
  return (
    <label className="grow" htmlFor="">{props.nome}
      <input id={props.id} placeholder={props.place} locale="pt-BR" type={props.dataType} value={props.type}
        onClick={() => props.handleButton && props.handleButton(props.descrHandle)}
