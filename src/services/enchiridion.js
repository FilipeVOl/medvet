...
export async function createEnchiridion(allDataState) {
  try {
    const data = await axios.post(
      "http://localhost:3333/create/enchiridion",
      allDataState
    );
    return data;
  } catch (e) {
...
export async function getEnchiridion(set) {
  try {
    const prontuarios = await axios.get(
...
export const getEnchiridionsAnimalId = async (id) => {
  try {
    const enchiridions = await axios.get(
      `http://localhost:3333/get/enchiridion/animal/${id}`
    );
...
export const getTeacherName = async (teacherId) => {
  try {
    const response = await axios.get(
      `http://localhost:3333/get/teacher/id/${teacherId}`
    );
...
export const getEnchiridionId = async (id) => {
  try {
    const enchiridion = await axios.get(
      `http://localhost:3333/get/enchiridion/${id}`
    );
...
export const deleteEnchiridion = async (id) => {
  try {
    const enchiridion = await axios.get(
      `http://localhost:3333/delete/enchiridion/${id}`
    );
    return enchiridion.data;
  } catch (error) {
    console.error(error);
