...
export default function Exames() {
  ...
  const handleAnimalSelect = (animal) => {
    // Normalizar o objeto animal para um formato padrão
  ...
  if (error) {
    ...
    <div className="font-Montserrat pl-14">
      <h1 className="p-14 h-10 text-2xl font-bold">Solicitação de Exames</h1>
      <div className="flex justify-between items-center mb-6 px-14">
        ...
        <div className="px-14">
          ...
          <FormExame animalData={selectedAnimal} />
        </div>
      )}
    </div>
  );
